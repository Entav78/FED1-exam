...
export function generatePostHtml(post) {
  ...
  // Set the post ID from the API data to the blog-post container
  postContainer.setAttribute("data-post-id", post.id); // Make sure 'post.id' corresponds to the actual ID from the API
