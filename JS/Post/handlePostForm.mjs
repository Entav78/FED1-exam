...
document.addEventListener("DOMContentLoaded", function () {
  ...
  editPostForm.addEventListener("submit", async function (event) {
    ...
    const post = {
      ...
      media: {
        url: document.getElementById("image").value || "", // Update this if handling file inputs differently
...
export async function loadPostData(postId) {
  ...
  try {
    ...
    document.getElementById("image").value = response.media.url; // Update if handling file inputs differently
  } catch (error) {
